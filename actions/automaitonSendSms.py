...
class SendSingleSms(Action):
    ...
    def run(self, phoneNume,smsMsg1,smsMsg2,APPID ,APPKEY ,TEMPLATE_IDS ,SMS_SIGN ,SMS_CODE_REDIS_EXPIRES):
        try:
            ...
            try:
                _Ret = ssender.send_with_param(86, phoneNume, TEMPLATE_IDS, content, SMS_SIGN, extend=extend,ext="")
